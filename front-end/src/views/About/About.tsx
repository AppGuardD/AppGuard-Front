    ...
    <div className="container flex-column text-white relative w-11/12 m-4  overflow-hidden">
      ...
      <div className="flex w-full h-[32rem] overflow-hidden">
        <div className="relative w-2/4 transition-all duration-500 ease-in-out overflow-hidden hover:w-full text-center group">
          <img
            className="w-full h-full grow object-cover opacity-50 group-hover:opacity-100 group-hover:contrast-125"
            src="https://i.pinimg.com/564x/8f/0b/2e/8f0b2ec5e74f39b4f7fbc791e7420f3e.jpg"
            alt=""
          />
        ...
        <div className="relative w-2/4 transition-all duration-500 ease-in-out overflow-hidden hover:w-full text-center group">
          <img
            className="w-full h-full grow object-cover opacity-50 group-hover:opacity-100 group-hover:contrast-125"
            src="https://i.pinimg.com/564x/3f/e1/6b/3fe16bf088b630d0f9b44b21d29f5aa1.jpg"
            alt=""
          />
          <div className="card-info">
            <p className="absolute top-16 w-full text-1.5xl uppercase text-white tracking-wide transform rotate-90 transition-all duration-500 ease-out group-hover:rotate-0 group-hover:text-2xl group-hover:text-center group-hover:bg-slate-950 group-hover:top-0">
        ...
        <div className="relative w-2/4 transition-all duration-500 ease-in-out overflow-hidden hover:w-full text-center group">
          <img
            className="w-full h-full grow object-cover opacity-50 group-hover:opacity-100 group-hover:contrast-125"
            src="https://i.pinimg.com/564x/6f/be/d2/6fbed2593ead0482a521ff4c099501aa.jpg"
            alt=""
          />
          <div className="card-info">
            <p className="absolute top-16 w-full text-1.5xl uppercase text-white tracking-wide transform rotate-90 transition-all duration-500 ease-out group-hover:rotate-0 group-hover:text-2xl group-hover:text-center group-hover:bg-slate-950 group-hover:top-0">
        ...
        <div className="relative w-2/4 transition-all duration-500 ease-in-out overflow-hidden hover:w-full text-center group">
          <img
            className="w-full h-full grow object-cover opacity-50 group-hover:opacity-100 group-hover:contrast-125"
            src="https://i.pinimg.com/736x/8a/6e/42/8a6e421dce43b473af8a71195ef458f1.jpg"
            alt=""
          />
          <div className="card-info">
            <p className="absolute top-16 w-full text-1.5xl uppercase text-white tracking-wide transform rotate-90 transition-all duration-500 ease-out group-hover:rotate-0 group-hover:text-2xl group-hover:text-center group-hover:bg-slate-950 group-hover:top-0">
            ...
            <div className="w-full absolute bottom-16 w-full flex items-center justify-center flex-col transform translate-y-20 transition-all duration-300 fill-white">
              ...
              <div className="transition-all duration-300 flex-row">
                <a className="m-3" href="https://www.linkedin.com/">
                  {linkedin}
                </a>
                <a className="m-3" href="https://github.com/">
                  {github}
                </a>
              </div>
            </div>
        ...
        <div className="relative w-2/4 transition-all duration-500 ease-in-out overflow-hidden hover:w-full text-center group">
          <img
            className="w-full h-full grow object-cover opacity-50 group-hover:opacity-100 group-hover:contrast-125"
            src="https://i.pinimg.com/564x/f5/d7/26/f5d7264fb45b255aa75143ed96d1bae0.jpg"
            alt=""
          />
          <div className="card-info">
            <p className="absolute top-16 w-full text-1.5xl uppercase text-white tracking-wide transform rotate-90 transition-all duration-500 ease-out group-hover:rotate-0 group-hover:text-2xl group-hover:text-center group-hover:bg-slate-950 group-hover:top-0">
        ...
        <div className="relative w-2/4 transition-all duration-500 ease-in-out overflow-hidden hover:w-full text-center group">
          <img
            className="w-full h-full grow object-cover opacity-50 group-hover:opacity-100 group-hover:contrast-125"
            src="https://i.pinimg.com/564x/ff/9e/4a/ff9e4a43552af9d734a08f458a6186c0.jpg"
            alt=""
          />
          <div className="card-info">
            <p className="absolute top-16 w-full text-1.5xl uppercase text-white tracking-wide transform rotate-90 transition-all duration-500 ease-out group-hover:rotate-0 group-hover:text-2xl group-hover:text-center group-hover:bg-slate-950 group-hover:top-0">
        ...
        <div className="relative w-2/4 transition-all duration-500 ease-in-out overflow-hidden hover:w-full text-center group">
          <img
            className="w-full h-full grow object-cover opacity-50 group-hover:opacity-100 group-hover:contrast-125"
            src="https://i.pinimg.com/564x/5d/fa/a8/5dfaa8c541b87e24a2bc92af38f5c194.jpg"
            alt=""
          />
          <div className="card-info">
            <p className="absolute top-16 w-full text-1.5xl uppercase text-white tracking-wide transform rotate-90 transition-all duration-500 ease-out group-hover:rotate-0 group-hover:text-2xl group-hover:text-center group-hover:bg-slate-950 group-hover:top-0">
